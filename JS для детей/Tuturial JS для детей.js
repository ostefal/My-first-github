...
return - выход из функции, возвращение результата
...
//Задания  //Задания  //Задания  //Задания  //Задания  //Задания  //Задания  //Задания  //Задания  //Задания  //Задания  
//Задания  //Задания  //Задания  //Задания  //Задания  //Задания  //Задания  //Задания  //Задания  //Задания  //Задания  
...
Анимация элементов средствами JQuery  Анимация элементов средствами JQuery  Анимация элементов средствами JQuery
Анимация элементов средствами JQuery  Анимация элементов средствами JQuery  Анимация элементов средствами JQuery
...
// Отложенная анимация delay
$("h2").fadeOut(1000).delay(3000).fadeIn(1000);
скроет за секунду, подождёт 3 сек, покажет за секунду
...
//  Интерактивное программирование   Интерактивное программирование   Интерактивное программирование   Интерактивное программирование
//  Интерактивное программирование   Интерактивное программирование   Интерактивное программирование   Интерактивное программирование
- это запуск и выполнение кода в заданное время или в ответ действий пользователя
...
handler - обработчик
event - событие явление. Содержит информацию о событии.
hint - подсказка
...
.offsetX              // свойство объекта (значение координаты Х)
.offsetY              // свойство объекта (значение координаты У)
.click(func); // Функция выполняется, когда пользователь щелкает элемент
.mousemove(func) - обработчик события Передвижение мыши // следит за передвижением мыши. Как только мышь переместиться запуститься код в скобках
...
// JS на работе  // JS на работе  // JS на работе  // JS на работе  // JS на работе  // JS на работе  // JS на работе  
// JS на работе  // JS на работе  // JS на работе  // JS на работе  // JS на работе  // JS на работе  // JS на работе  
// JS на работе  // JS на работе  // JS на работе  // JS на работе  // JS на работе  // JS на работе  // JS на работе  
